...
See also: [Network modes](../networking/modes) · [Rule grammar](../networking/rules) · [Egress groups (networking)](../networking/groups) · [`sbx net groups`](../cli/net).
...
optional `{VERB,…}` method prefix. See the [rule grammar](../networking/rules).
...
[`sbx net groups`](../cli/net) and [Egress groups](../networking/groups).
