...
an app writes there is the app's choice. Provisioning adds nothing to it: a backend writes
into the project's store or into sbx's data directory, never into the tree.
