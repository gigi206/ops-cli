...
| [`groups`](#sbx-net-groups) | list the reusable egress groups, or resolve one |
...
An egress group is a named set of egress entries declared once beside the global
...
sbx net groups import ci.toml          # …file it under net-groups/ci.toml there
```
