...
title: "`xai`: xAI"
sidebar_label: "xai"
description: "xAI's Grok API."
sidebar_position: 39
---

# `xai`: xAI

xAI's Grok API. The mechanics, posture, and scoping are in [the shared page](../); this page only adds what is specific to xAI.
...
- **Reference:** [https://docs.x.ai/docs/models](https://docs.x.ai/docs/models)
...
*This page is generated from `examples/secrets/xai/README.md`. Edit it there:
