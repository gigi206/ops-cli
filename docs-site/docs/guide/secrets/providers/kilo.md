...
endpoint. The shared mechanics, posture, and scoping are in [Secrets](../); this page only adds what is specific to Kilo.
...
that the allowlist reaches the host (see [Secrets](../)).
