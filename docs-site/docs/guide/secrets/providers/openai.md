...
OpenAI's chat API. The mechanics, posture, and scoping are in [Secrets](../); this page only adds what is specific to OpenAI.
...
*This page is generated from `examples/secrets/openai/README.md`. Edit it there:
