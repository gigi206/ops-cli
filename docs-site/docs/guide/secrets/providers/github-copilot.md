---
title: "`github-copilot`: GitHub Copilot (individual API)"
sidebar_label: "github-copilot"
description: "GitHub's OpenAI-compatible Copilot surface; individual subscriptions (api.individual.githubcopilot.com)."
sidebar_position: 14
---
...
in [Secrets](../); this page only adds what is specific to
GitHub Copilot.
...
- **Reference:** [https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/authenticate](https://docs.github.com/en/copilot/how-tos/copilot-sdk/auth/authenticate) ·
  [https://api.individual.githubcopilot.com/models](https://api.individual.githubcopilot.com/models)
...
plugin do it) and check the posture/allowlist (see [Secrets](../)).

---

*This page is generated from `examples/secrets/github-copilot/README.md`. Edit it there:
