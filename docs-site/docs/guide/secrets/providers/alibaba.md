---
title: "`alibaba`: Alibaba (Qwen)"
sidebar_label: "alibaba"
description: "Alibaba's DashScope platform."
sidebar_position: 1
---

# `alibaba`: Alibaba (Qwen)

Alibaba's DashScope platform. The mechanics, posture, and scoping are in [the shared page](../); this page only adds what is specific to Alibaba.
...
*This page is generated from `examples/secrets/alibaba/README.md`. Edit it there:
