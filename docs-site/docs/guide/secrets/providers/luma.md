---
title: "`luma` — Luma (Dream Machine)"
sidebar_label: "luma"
description: "Luma's image/video generation API (Dream Machine)."
sidebar_position: 22
---
...
- **Reference:** [https://docs.lumalabs.ai/docs/api](https://docs.lumalabs.ai/docs/api)
...
*This page is generated from `examples/secrets/luma/README.md`. Edit it there:
