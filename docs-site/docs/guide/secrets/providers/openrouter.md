...
the multi-provider router that fronts every major model. The mechanics, posture, and scoping are in [Secrets](../); this page only adds what is specific to OpenRouter.
