...
mod tests {
    ...
    fn upgrade_mise_and_upgrade_nix_roll_separate_locks() {
        ...
        // The baseline with only the global pin set: `resolved_channels` is written once for
        // exactly this, and three other launch-tree tests already share it.
        let cfg = |global: &str| crate::testutil::resolved_channels(Some(global), None);
