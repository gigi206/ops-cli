...
const UNDOCUMENTED_MODULE_ITEMS: &[(&str, &str)] = &[
    ...
    ("sandbox/proc_enforce/mod.rs", "wrap_command"),
    ("sandbox/proc_enforce/notify.rs", "notif_id_valid_code"),
    ("sandbox/proc_enforce/notify.rs", "notif_recv_code"),
    ("sandbox/proc_enforce/notify.rs", "notif_send_code"),
    ("sandbox/proc_enforce/notify.rs", "seccomp_ioc"),
    ("sandbox/proc_enforce/overlay.rs", "OverlayInner"),
    ("sandbox/proc_enforce/pending.rs", "Parked"),
