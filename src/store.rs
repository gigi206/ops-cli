...
pub(crate) use channel::{
    LockTarget, Origin, Scope, Upgrade, is_pinned_revision, live_base_revisions,
    live_mise_revisions, read_global_lock, read_lock_lines, resolve_engine_ref, revision_of,
    witness_revision, write_lock,
};
#[cfg(test)]
