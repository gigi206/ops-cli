...
See also: [Portable profiles](profiles.md) · [The app framework](README.md) · [Secrets](../secrets/README.md) · the repository [`examples/README.md`](https://github.com/gigi206/ops-cli/blob/ops-v2/examples/README.md).
...
[`examples/README.md`](https://github.com/gigi206/ops-cli/blob/ops-v2/examples/README.md).
...
Electron/GUI agents. Each needs a [Wayland display](../configuration/gui.md)
(`gui = "wayland"`), and most also enable [`gpu`](../configuration/gpu.md) and the in-cage
[desktop portal](../configuration/dbus.md) (`dbus = true`). Where the tool's sign-in opens
...
The app serves a UI inside the cage; the profile [forwards](../networking/forward.md) its
...
Each profile gets its own persistent, isolated [`$HOME`](home.md), shared across projects by
...
[Bundles](../configuration/bundles.md) and [`sbx bundle`](../cli/bundle.md).
...
[Packages](../configuration/packages.md). Advancing an already-installed version via
`sbx upgrade` is supported: see [Upgrading](../housekeeping/upgrade.md).
...
[`--net-learn`](../cli/app.md#learning-an-apps-egress---net-learn), which turns each refusal
...
cage. See the repository [`examples/README.md`](https://github.com/gigi206/ops-cli/blob/ops-v2/examples/README.md) for the
