...
See also: [Prerequisites](doctor.md) · [Trust](../concepts/trust.md) · [Networking overview](../networking/README.md) · [Configuration overview](../configuration/README.md).
...
[Prerequisites](doctor.md).

## `sbx run` refuses to start — my config is silently ignored
...
See [Trust](../concepts/trust.md) and [Networking overview](../networking/README.md).
...
To allow it, add a rule to `[network] allow` (see [Networking rules](../networking/rules.md))
...
[Resolvers](../secrets/resolvers.md) and [Resolver plugins](../secrets/plugins.md).
...
and adjust `[proc]` (see [proc policy](../configuration/proc.md)).
...
[gui](../configuration/gui.md) and [gpu](../configuration/gpu.md).
