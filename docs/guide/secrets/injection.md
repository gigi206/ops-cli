...
[../networking/modes.md](../networking/modes.md) and
[../configuration/network.md](../configuration/network.md).
...
cooperating destination. The inbound tripwire in [redaction.md](redaction.md)
