...
third list, [`mute`](observability.md#muting-noisy-refusals-network-mute-selinux-dontaudit), a log filter that hides a *denied* request's line without changing the verdict.
