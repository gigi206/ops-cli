...
is already permitted); its one job is the [SSRF exception](architecture.md#the-ssrf-guard), a private or internal address is refused unless an allow rule names that exact
