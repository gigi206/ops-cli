...
to write; see [`bwrap-security-stack.md` §4](https://github.com/gigi206/ops-cli/blob/ops-v2/docs/bwrap-security-stack.md) for the
posture rationale.
...
- Design docs: [security stack](https://github.com/gigi206/ops-cli/blob/ops-v2/docs/bwrap-security-stack.md) (covers seccomp denylist + cgroup v2)
