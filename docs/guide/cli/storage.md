...
You do not have to find out the hard way. [`sbx doctor`](doctor.md) reports the storage line, the filesystem the data directory sits on, and whether an encapsulated volume is available,
