...
Together AI's hosted models. The mechanics, posture, and scoping are in [the shared page](../README.md); this page only adds what is specific to Together AI.
...
- **Reference:** <https://docs.together.ai/docs/serverless-models>
