...
MiniMax's hosted API. The mechanics, posture, and scoping are in [the shared page](../README.md); this page only adds what is specific to MiniMax.
...
- **Reference:** <https://platform.minimax.io/docs/api-reference>
