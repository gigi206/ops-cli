...
the aggregator that re-exposes its model catalogue behind OpenAI-, Anthropic-, and Gemini-compatible endpoints. The mechanics, posture, and scoping are in [the shared page](../README.md); this page only adds what is specific to TokenRouter.
...
- **Reference:** <https://www.tokenrouter.com/docs/>
