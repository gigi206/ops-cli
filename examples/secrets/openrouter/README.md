...
the multi-provider router that fronts every major model. The mechanics, posture, and scoping are in [the shared page](../README.md); this page only adds what is specific to OpenRouter.
