...
StepFun's hosted API (Step models). The mechanics, posture, and scoping are in [the shared page](../README.md); this page only adds what is specific to StepFun (Global).
...
- **Reference:** <https://platform.stepfun.ai/docs/en/overview/concept>
